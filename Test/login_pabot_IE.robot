...
IN01: login Usuário Inválido
   [Tags]   login
    Usuário inválido, senha válida no internet explorer
    Valida mensagem Erro Usuário Inválido


IN02: login Senha Inválida
   [Tags]   login
    Usuário válido, senha inválida no internet explorer
    Valida mensagem Senha Inválida


IN03: login Caracteres especiais
   [Tags]   login
    Usuário caracteres Especiais, senha caracteres Especiais no internet explorer
    Valida mensagem Erro de login
   

IN04: login não preenchido
   [Tags]   login
    Não informar Usuário e não informar senha no internet explorer
    Valida alerta de campo obrigatório
 

IN05: login efetuado com sucesso
   [Tags]   login
    Usuário válido, senha válida no internet explorer
    Valida tela inicial Dashboard


IN06: login efetuado com sucesso 2
   [Tags]   login
    Usuário válido, senha válida 2 no internet explorer
